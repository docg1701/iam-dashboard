...
class TestVectorStorageTool:
    ...
    def test_validate_pgvector_setup_success(self, mock_get_db: Mock, vector_tool: VectorStorageTool) -> None:
    ...
    @patch('app.core.database.get_db')
    def test_validate_pgvector_setup_extension_missing(self, mock_get_db: Mock, vector_tool: VectorStorageTool) -> None:
    ...
    def test_validate_pgvector_setup_failure(self, mock_get_db: Mock, vector_tool: VectorStorageTool) -> None:
    ...
    def test_chunk_text_simple(self, vector_tool: VectorStorageTool) -> None:
        ...
        assert all("metadata" in chunk and chunk["metadata"] == metadata for chunk in chunks)
    ...
    def test_chunk_text_large_document(self, vector_tool: VectorStorageTool) -> None:
        ...
        if len(chunks) > 1:
            ...
            assert chunks[0]["end_pos"] > chunks[1]["start_pos"] - vector_tool.chunk_overlap

    @patch('google.generativeai.embed_content')
    def test_generate_embedding_success(self, mock_embed_content: Mock, vector_tool: VectorStorageTool) -> None:
    ...
    def test_generate_embedding_empty_text(self, vector_tool: VectorStorageTool) -> None:
    ...
    def test_generate_embedding_failure(self, mock_embed_content: Mock, vector_tool: VectorStorageTool) -> None:
    ...
    def test_generate_embeddings_batch_success(self, vector_tool: VectorStorageTool) -> None:
    ...
    def test_generate_embeddings_batch_partial_failure(self, vector_tool: VectorStorageTool) -> None:
    ...
    @patch('app.core.database.get_db')
    def test_store_document_embeddings_success(self, mock_get_db: Mock, vector_tool: VectorStorageTool) -> None:
    ...
    @patch('app.core.database.get_db')
    def test_store_document_embeddings_failure(self, mock_get_db: Mock, vector_tool: VectorStorageTool) -> None:
    ...
    @patch('app.core.database.get_db')
    def test_search_similar_content_success(self, mock_get_db: Mock, vector_tool: VectorStorageTool) -> None:
    ...
    def test_search_similar_content_embedding_failure(self, vector_tool: VectorStorageTool) -> None:
    ...
    def test_process_document_text_success(self, vector_tool: VectorStorageTool) -> None:
        ...
        with patch.object(vector_tool, 'chunk_text') as mock_chunk, \
    ...
    def test_process_document_text_no_chunks(self, vector_tool: VectorStorageTool) -> None:
    ...
    def test_process_document_text_embedding_failure(self, vector_tool: VectorStorageTool) -> None:
    ...
    def test_process_document_text_storage_failure(self, vector_tool: VectorStorageTool) -> None:
