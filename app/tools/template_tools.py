...
class TemplateManagerTool:
    ...
    def __init__(self, templates_directory: str | None = None):
        ...
        self.templates_directory = (
            Path(templates_directory) if templates_directory else None
        )
    ...
    def get_questionnaire_template(
        ...
        try:
            ...
            if self.templates_directory:
                template = self._load_template_from_file(
                    template_type, profession, disease_category
                )
                if template:
                    return {
                        "success": True,
    ...
    def apply_template_formatting(
        ...
        try:
            ...
            result = {
                ...
                "formatting_rules_applied": len(
                    template_config.get("formatting_rules", [])
                ),
            }
    ...
    def validate_questionnaire_format(
        self, questionnaire_text: str, template_config: dict[str, Any] | None = None
    ) -> dict[str, Any]:
        ...
        try:
            ...
            if not self._validate_question_numbering(questionnaire_text):
                validation_results["warnings"].append(
                    "Question numbering may be inconsistent"
                )
    ...
    def _load_default_templates(self) -> dict[str, Any]:
        ...
        return {
            "medical_examination": {
                ...
                "required_sections": ["DADOS DO EXAMINANDO", "QUESITOS"],
                "min_questions": 5,
                "max_questions": 20,
                ...
                "sections": {
                    ...
                    "questions": {"title": "QUESITOS:", "format": "numbered_list"},
                },
            },
    ...
    def _load_template_from_file(
        self, template_type: str, profession: str | None, disease_category: str | None
    ) -> dict[str, Any] | None:
        ...
        try:
            ...
            logger.warning(
                f"Failed to load template from file {template_file}: {str(e)}"
            )
            return None
    ...
    def _apply_section_formatting(
        self, text: str, template_config: dict[str, Any]
    ) -> str:
