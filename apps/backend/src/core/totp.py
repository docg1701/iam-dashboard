...
class TOTPService:
    ...
    def generate_backup_codes(self, count: int = 8, strength: str = "high") -> list[str]:
        ...
        while len(backup_codes) < count and attempts < max_attempts:
            ...
            if strength == "high":
                ...
                code = code.replace('0', '2').replace('O', '3').replace('I', '4').replace('L', '5').replace('1', '6')
            else:
    ...
    def verify_backup_code(
        ...
        weak_codes = {
            "12345678", "ABCDEFGH", "00000000", "11111111", "PASSWORD", 
            "BACKUP12", "CODE1234", "TEST1234", "ADMIN123", "USER1234"
        }
