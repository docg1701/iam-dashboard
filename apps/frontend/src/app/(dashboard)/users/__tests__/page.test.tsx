...
describe("UsersPage", () => {
  ...
  describe("Page Structure and Layout", () => {
    ...
    test("renders search and filter controls", async () => {
      ...
      expect(
        screen.getByPlaceholderText(/buscar por email/i),
      ).toBeInTheDocument();
  ...
  describe("User Interactions", () => {
    ...
    test("handles new user button click", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByRole("dialog", { name: /criar novo usuário/i }),
        ).toBeInTheDocument();
      });
  ...
  describe("Error Handling", () => {
    ...
    test("handles empty user list", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText(/nenhum usuário/i) ||
            screen.getByText(/sem usuários/i),
        ).toBeInTheDocument();
      });
    });
  });
