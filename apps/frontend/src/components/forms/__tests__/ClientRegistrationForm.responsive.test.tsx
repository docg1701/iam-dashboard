  ...
  describe("Accessibility Compliance", () => {
    ...
    it("should have proper heading structure for screen readers", () => {
      ...
      const nameLabel = screen
        .getByLabelText(/nome completo/i)
        .closest('[data-slot="form-item"]')
        ?.querySelector("label");
      const cpfLabel = screen
        .getByLabelText(/cpf/i)
        .closest('[data-slot="form-item"]')
        ?.querySelector("label");
      const dateLabel = screen
        .getByLabelText(/data de nascimento/i)
        .closest('[data-slot="form-item"]')
        ?.querySelector("label");
      const notesLabel = screen
        .getByLabelText(/observações/i)
        .closest('[data-slot="form-item"]')
        ?.querySelector("label");
    ...
    it("should provide proper field descriptions for assistive technology", () => {
      ...
      expect(
        screen.getByText(/cpf no formato xxx\.xxx\.xxx-xx/i),
      ).toBeInTheDocument();
      expect(
