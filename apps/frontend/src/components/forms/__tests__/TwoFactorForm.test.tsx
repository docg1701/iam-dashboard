...
describe("TwoFactorForm", () => {
  ...
  it("should auto-submit when all 6 digits are filled and call onSuccess", async () => {
    ...
    render(
      <TestWrapper>
        <TwoFactorForm onSubmit={realOnSubmit} onSuccess={realOnSuccess} />
      </TestWrapper>,
    );
  ...
  it("should handle verification errors and call onError", async () => {
    ...
    render(
      <TestWrapper>
        <TwoFactorForm onSubmit={realOnSubmit} onError={realOnError} />
      </TestWrapper>,
    );
  ...
  it("should handle back button click and call onBack", async () => {
    ...
    render(
      <TestWrapper>
        <TwoFactorForm onSubmit={realOnSubmit} onBack={realOnBack} />
      </TestWrapper>,
    );
  ...
  it("should disable back button during loading", async () => {
    ...
    render(
      <TestWrapper>
        <TwoFactorForm onSubmit={delayedOnSubmit} onBack={realOnBack} />
      </TestWrapper>,
    );
