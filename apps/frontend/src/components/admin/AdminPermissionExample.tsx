...
export const AdminPermissionExample: React.FC = () => {
  ...
  const handleBulkOperationComplete = (
    results: BulkPermissionAssignResponse,
  ) => {
    ...
    <div className="min-h-screen bg-gray-50/50 p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex flex-col space-y-4 sm:flex-row sm:items-center sm:justify-between sm:space-y-0">
          <div>
            ...
            <p className="text-muted-foreground">
              Interface administrativa para gerenciar permissões de usuários e
              agentes
            </p>
          </div>
        ...
        <div className="space-y-6">
          ...
          {activeTab === "templates" && (
            <PermissionTemplates onTemplateApplied={handleTemplateApplied} />
          )}
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Instruções para desenvolvedores sobre como integrar esses
              componentes
            </CardDescription>
          </CardHeader>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Componente principal para visualizar e editar permissões em
                  formato de matriz. Suporta filtros, busca e operações em lote.
                </p>
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Dialog para edição detalhada de permissões de um usuário
                  específico. Inclui histórico de alterações e validação.
                </p>
                <code className="text-xs bg-gray-100 p-2 rounded block">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Dialog para operações em lote - aplicar templates,
                  conceder/revogar permissões para múltiplos usuários
                  simultaneamente.
                </p>
                <code className="text-xs bg-gray-100 p-2 rounded block">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Interface para criar, editar e gerenciar templates de
                  permissões reutilizáveis para facilitar a gestão.
                </p>
                <code className="text-xs bg-gray-100 p-2 rounded block">
      ...
      <BulkPermissionDialog
        selectedUsers={EXAMPLE_USERS.filter((u) =>
