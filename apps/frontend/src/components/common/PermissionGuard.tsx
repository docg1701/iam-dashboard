...
const PermissionErrorComponent: React.FC<{
  ...
  <Alert variant="destructive" className="max-w-md">
    ...
    <AlertDescription>
      ...
      {operation && ` para ${getOperationText(operation)}`}
...
> = (props) => <PermissionGuard {...props} operation="create" />;
...
export const ReadPermissionGuard: React.FC<
  Omit<PermissionGuardProps, "operation">
> = (props) => <PermissionGuard {...props} operation="read" />;
...
export const UpdatePermissionGuard: React.FC<
  Omit<PermissionGuardProps, "operation">
> = (props) => <PermissionGuard {...props} operation="update" />;
...
export const DeletePermissionGuard: React.FC<
  Omit<PermissionGuardProps, "operation">
> = (props) => <PermissionGuard {...props} operation="delete" />;
...
export function withPermissionGuard<P extends object>(
  ...
  const WrappedComponent: React.FC<P & { userId?: string }> = ({
    userId,
    ...props
  }) => (
    <PermissionGuard
