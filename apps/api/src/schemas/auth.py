...
class LoginRequest(BaseModel):
    ...
    totp_code: Optional[str] = Field(None, min_length=6, max_length=6, description="TOTP 2FA code")
...
class Enable2FARequest(BaseModel):
    ...
    totp_code: str = Field(..., min_length=6, max_length=6, description="TOTP 2FA code for verification")
