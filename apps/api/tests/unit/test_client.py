...
class TestClientModel:
    ...
    def test_client_batch_creation(self):
        ...
        for client in clients:
            age = today.year - client.birth_date.year
            if today.month < client.birth_date.month or (
                today.month == client.birth_date.month
                and today.day < client.birth_date.day
            ):
                age -= 1
            ages.append(age)
    ...
    def test_clients_for_user(self):
        ...
        clients = ClientFactory.create_clients_for_user(
            user_id=user.id, count=client_count
        )
    ...
    def test_client_repr(self):
        ...
        client = ClientFactory.create_client(name="João Silva", cpf="11144477735")
    ...
    def test_invalid_cpf_numbers(self):
        ...
        for cpf in invalid_cpfs:
            ...
            assert any(
                ...
                for keyword in ["cpf", "digits", "required", "invalid"]
            )
...
class TestClientBirthDateValidation:
    ...
    def test_birth_date_required(self):
        ...
        with pytest.raises((ValidationError, TypeError)):
            Client(name="Test Client", cpf="11144477735", created_by=uuid.uuid4())
