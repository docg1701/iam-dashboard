...
class TestUserModel:
    ...
    def test_user_creation_with_custom_values(self):
        ...
        user = UserFactory.create_user(
            email=custom_email, role=custom_role, totp_secret=custom_totp
        )
    ...
    def test_user_with_login_history(self):
        ...
        expected_date = datetime.now(UTC) - timedelta(days=days_ago)
    ...
    def test_multiple_users_creation(self):
        ...
        users = UserFactory.create_multiple_users(
            count=user_count, role_distribution=role_distribution
        )
    ...
    def test_user_repr(self):
        ...
        user = UserFactory.create_user(email="test@example.com", role=UserRole.ADMIN)
...
class TestUserValidation:
    ...
    def test_user_optional_fields_can_be_none(self):
        ...
        user = UserFactory.create_user(
            totp_secret=None, last_login_at=None, locked_until=None
        )
...
class TestUserRoleEnum:
    ...
    def test_user_role_comparison(self):
        ...
        assert UserRole.SYSADMIN == "sysadmin"  # str enum equals its string value
