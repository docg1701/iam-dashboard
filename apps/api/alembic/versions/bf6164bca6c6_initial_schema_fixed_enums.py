...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "session_id", sqlmodel.sql.sqltypes.AutoString(length=128), nullable=True
        ),
        sa.Column(
    ...
    op.create_index(
        op.f("ix_user_agent_permissions_user_id"),
        "user_agent_permissions",
        ["user_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        op.f("ix_user_agent_permissions_user_id"), table_name="user_agent_permissions"
    )
    op.drop_index(
        "ix_user_agent_permissions_user_agent", table_name="user_agent_permissions"
    )
